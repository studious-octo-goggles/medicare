...
//-----------------Invoice----------------------------------------
app.get('/invoiceCSS1',function(req,res){
    res.sendFile( 'bootstrap.min.css',{root:'./web/Invoice/bootstrap/css/'} ); 
});
app.get('/invoiceCSS2',function(req,res){
    res.sendFile( 'font-awesome.min.css',{root:'./web/Invoice/font-awesome/css/'} ); 
});
...
app.get('/patDocPic', function (req, res) {  
 ...
 app.get('/fiveStar', function (req, res) {  
     console.log("dondho image");
    res.sendFile( 'fiveStar.png',{root:'./img/'} ); 
 })
 app.get('/fourStar', function (req, res) {  
    res.sendFile( 'fourStar.png',{root:'./img/'} ); 
 })
 app.get('/threeStar', function (req, res) {  
    console.log("dondho image");
   res.sendFile( 'threeStar.png',{root:'./img/'} ); 
})
app.get('/twoStar', function (req, res) {  
   res.sendFile( 'twoStar.png',{root:'./img/'} ); 
})
app.get('/oneStar', function (req, res) {  
    console.log("dondho image");
   res.sendFile( 'oneStar.png',{root:'./img/'} ); 
})
app.get('/noStar', function (req, res) {  
   res.sendFile( 'noStar.png',{root:'./img/'} ); 
})
//-------html files-----------------------------------------------------------
var onePatSearch;
var sId={};
...
app.post('/changePass',function(req,res){
    ...
    var hashed_pass1 = crypto.createHash('sha512').update(oldpassword).digest("hex");
    var newpassword=req.body.newPass;
    var hashed_pass2 = crypto.createHash('sha512').update(newpassword).digest("hex");
    var query = doc.findOneAndUpdate({doc_id:docCurrentId, doc_password:hashed_pass1},{doc_password: hashed_pass2}, { new: true});
    query.exec(function(err,data){
      if(err) return handleError(err);
      res.sendFile( 'ChangePassword.html',{root:'./web/'} );  
    });
